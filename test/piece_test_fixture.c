 ...
 test_piece_colour_macro(void)
{
 ...
 test_piece_classification_IS_BIG_PIECE(void)
{
 ...
 test_piece_classification_IS_MAJOR_PIECE(void)
{
 ...
 test_piece_classification_IS_MINOR_PIECE(void)
{
 ...
 test_piece_to_char_conversion(void)
{
