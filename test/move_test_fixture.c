 ...
 */
	...
	mv_bitmap mv = MOVE(a2, a3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(a2, a4, NO_PIECE, NO_PIECE, MFLAG_PAWN_START, 0);
	//print_move_details(mv);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(c2, c3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(e2, e3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(e2, e4, NO_PIECE, NO_PIECE, MFLAG_PAWN_START, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(h3, h4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(b4, b5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(b4, c5, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(d4, d5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(d4, c5, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(d4, e5, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f5, f6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, g8, NO_PIECE, W_QUEEN, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, g8, NO_PIECE, W_KNIGHT, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, g8, NO_PIECE, W_BISHOP, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, g8, NO_PIECE, W_ROOK, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, f8, B_BISHOP, W_ROOK, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, f8, B_BISHOP, W_QUEEN, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, f8, B_BISHOP, W_BISHOP, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, f8, B_BISHOP, W_KNIGHT, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
 ...
 */
	...
	mv = MOVE(g7, h8, B_ROOK, W_KNIGHT, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, h8, B_ROOK, W_BISHOP, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, h8, B_ROOK, W_QUEEN, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g7, h8, B_ROOK, W_ROOK, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_generation_black_pawn_moves(void)
{
	...
	mv_bitmap mv = MOVE(g2, g1, NO_PIECE, B_ROOK, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, g1, NO_PIECE, B_QUEEN, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, g1, NO_PIECE, B_BISHOP, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, g1, NO_PIECE, B_KNIGHT, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, h1, W_ROOK, B_KNIGHT, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, h1, W_ROOK, B_BISHOP, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, h1, W_ROOK, B_ROOK, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, h1, W_ROOK, B_QUEEN, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	mv = MOVE(g2, g1, NO_PIECE, B_ROOK, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g2, g1, NO_PIECE, B_QUEEN, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f4, f3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(b5, b4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(d5, d4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_generation_white_knight_pawn_moves(void)
{
	...
	// check moves from d3
	mv_bitmap mv = MOVE(d3, f2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, e1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, c1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, b2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, b4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, c5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, e5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, f4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	// check moves from g5
	mv = MOVE(g5, h3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g5, f3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g5, e4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g5, f7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g5, h7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(g5, e6, B_KNIGHT, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_generation_black_knight_pawn_moves(void)
{
	...
	// start on b3
	mv_bitmap mv = MOVE(b3, d2, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, c1, W_BISHOP, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, a1, W_ROOK, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(b3, d2, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, c1, W_BISHOP, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, a1, W_ROOK, NO_PIECE, 0, 0);
	...
	mv = MOVE(d5, f4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d5, e3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d5, c3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d5, b4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d5, b6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d5, f6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_generation_king_moves(void)
{
	...
	mv = MOVE(a2, b3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a2, b1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a2, a1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	// black king on h1
	mv = MOVE(h1, g2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h1, g1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	// black king on d3
	mv = MOVE(d3, c4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, c3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, c2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, d2, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, d4, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d3, e2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	// black king on c7
	mv = MOVE(c7, b6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, b7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, b8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, c8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, d8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_generation_sliding_diagonal_moves(void)
{
	...
	mv_bitmap mv = MOVE(b3, a4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, c2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, d1, W_BISHOP, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, a2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b3, c4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(c1, b2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c1, a3, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c1, d2, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
///////////////////////////////////////////////////
	...
	mv = MOVE(d1, c2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d1, b3, B_BISHOP, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d1, e2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d1, f3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(d1, g4, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(c7, b6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, a5, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, d6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, b8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c7, d8, NO_PIECE, NO_PIECE, 0, 0);
...
void test_generation_sliding_horizontal_and_vertical_moves(void)
{
	...
	mv_bitmap mv = MOVE(g2, e2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g2, f2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g2, h2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g2, g1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g2, g3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(g2, g4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(b7, b8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b7, a7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b7, b6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b7, b5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(b7, b4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	mv = MOVE(e1, d1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, c1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, b1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, a1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, f1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, g1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, h1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, e8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f6, f7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, f8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, g6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, a6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, b6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, c6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, d6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, e6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, f5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, f4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f6, f3, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_king_castling_moves(void)
{
	...
	assert_true(mvl->move_count == 2);
	mv_bitmap mv = MOVE(e1, g1, NO_PIECE, NO_PIECE, MFLAG_CASTLE, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e1, c1, NO_PIECE, NO_PIECE, MFLAG_CASTLE, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	assert_true(mvl->move_count == 2);
	mv = MOVE(e8, g8, NO_PIECE, NO_PIECE, MFLAG_CASTLE, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, c8, NO_PIECE, NO_PIECE, MFLAG_CASTLE, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_generation_queen_moves(void)
{
	...
	// check W_QUEEN's
	mv_bitmap mv = MOVE(h6, h7, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, f6, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, g6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, g7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, f8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, g5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, f4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, e3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, d2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(h6, c1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(c2, b3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c2, a4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c2, b2, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c2, b1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c2, c1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c2, d1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(c2, d2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	...
	mv = MOVE(a6, a7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, a8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, b6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, c6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, d6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, e6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, b7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, c8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, a5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(a6, a4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(e8, d8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, c8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, b8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, a8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, d7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, c6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, f8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, g8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, h8, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, f7, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, g6, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(e8, h5, W_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
// check the queen
	...
	mv = MOVE(f3, e3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, d3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, e2, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, d1, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, g3, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, h3, B_PAWN, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, f4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, f5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, f6, B_KNIGHT, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));

	mv = MOVE(f3, g4, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
	mv = MOVE(f3, h5, NO_PIECE, NO_PIECE, 0, 0);
	assert_true(TEST_is_move_in_list(mvl, mv));
...
void test_en_passant(void)
{
	...
	mv = MOVE(d5, c6, NO_PIECE, NO_PIECE, MFLAG_EN_PASSANT, 0);
	make_move(brd, mv);
