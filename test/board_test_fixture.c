...
} } void test_add_to_board()
{
    ...
    assert_true(get_piece_at_square(the_board, a8) ==
		  (piece_id_t) W_PAWN);
    assert_true(get_piece_at_square(the_board, g3) ==
		 (piece_id_t) B_QUEEN);
    assert_true(get_piece_at_square(the_board, b6) ==
		 (piece_id_t) W_PAWN);
    assert_true(get_piece_at_square(the_board, a4) ==
		 (piece_id_t) W_KING);
    assert_true(get_piece_at_square(the_board, h8) ==
		 (piece_id_t) W_ROOK);
