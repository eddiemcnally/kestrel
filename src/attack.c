...
static bool is_knight_attacking_square(const struct board *brd, U64 sqBB, enum piece attacking_piece);
static bool is_king_attacking_square(const struct board *brd, U64 sqBB, enum piece attacking_piece);
static bool is_rook_or_queen_attacking_square(const struct board *brd, enum square sq, U64 rq_bb);
static bool is_bishop_or_queen_attacking_square(const struct board *brd, enum square sq, U64 bq_bb);
...
static inline bool is_rook_or_queen_attacking_square(const struct board *brd, enum square sq, U64 rq_bb)
{       
    while (rq_bb!= 0) {
...
static inline bool is_bishop_or_queen_attacking_square(const struct board *brd, enum square sq, U64 bq_bb)
{
    while (bq_bb!= 0) {
...
static inline bool is_knight_attacking_square(const struct board *brd, U64 sqBB, enum piece attacking_piece)
{
...
static inline bool is_BLACK_pawn_attacking_square(const struct board *brd, U64 sqBB)
{
...
static inline bool is_WHITE_pawn_attacking_square(const struct board *brd, U64 sqBB)
{
...
static inline bool is_king_attacking_square(const struct board *brd, U64 sqBB, enum piece attacking_piece)
{   
...
bool TEST_is_pawn_attacking_square(const struct board *brd, enum square sq, enum colour attacking_side){
	if (attacking_side == WHITE){
		return is_WHITE_pawn_attacking_square(brd, square_to_bitboard(sq));
	} else {
		return is_BLACK_pawn_attacking_square(brd, square_to_bitboard(sq));
	} 
}
